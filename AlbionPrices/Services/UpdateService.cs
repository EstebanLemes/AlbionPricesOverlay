...
public class UpdateService
{
    ...
    public UpdateService(string repoOwner, string repoName)
    {
        ...
        System.Diagnostics.Debug.WriteLine($"UpdateService: owner={repoOwner}, repo={repoName}");
        System.Diagnostics.Debug.WriteLine($"Current version from assembly: {_currentVersion}");
    }
    ...
    public async Task CheckForUpdateAsync()
    {
        try
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Update check: HTTP {(int)httpResponse.StatusCode} (no releases or repo not found)");
                return;
            }
            ...
            if (release == null) {
                System.Diagnostics.Debug.WriteLine("No release data");
                return;
            }
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Comparing: current={_currentVersion} vs latest={latestVer}");
                IsUpdateAvailable = latestVer > _currentVersion;
                System.Diagnostics.Debug.WriteLine($"IsUpdateAvailable: {IsUpdateAvailable}");
            ...
            System.Diagnostics.Debug.WriteLine($"Update check complete: available={IsUpdateAvailable}, latest={LatestVersion}");
        }
        catch (Exception ex)
        {
